...
There are a few tidyverse functions we'll sometimes use:
...
class: bottom, center
background-image: url(images/dplyr_filter.png)
background-size: contain
...
Discuss select with it, too. 

---

class: bottom, center
background-image: url(images/dplyr_mutate.png)
background-size: contain
...
class: bottom, center
background-image: url(images/tidyr_spread_gather.png)
background-size: contain
